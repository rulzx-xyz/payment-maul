...
export const IconArrowLeft: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
...
export const IconQrcode: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4h4v4H4zM4 16h4v4H4zM16 4h4v4h-4zM16 16h4v4h-4zM10 4h4M10 20h4M4 10h4M16 10h4M10 10h4v4h-4z"></path></svg>
);
...
export const IconCheckCircle: React.FC<{ className?: string }> = ({ className = 'w-8 h-8' }) => (
